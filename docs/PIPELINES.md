...
| version | `cargo run -q -p atlas -- --version` | prints 0.1.5 |
...
| tui-version | `cd line && go run ./cmd/atlas-tui --version` | atlas-tui 0.1.5 |
...
| version | Response contains 0.1.5 | version matches |
