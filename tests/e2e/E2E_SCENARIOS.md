...
|---|---|---|---|
| S1-1 | atlas --version | atlas | prints 0.1.6 |
| S1-2 | atlas-mcp --version | atlas-mcp | prints 0.1.6 |
| S1-3 | atlas-tui --version | atlas-tui | prints atlas-tui 0.1.6 |
| S1-4 | atlas-town --version | atlas-town | prints 0.1.6 |
| S1-5 | atlas-door --version | atlas-door | prints 0.1.6 |
...
|---|---|---|---|
| S9-1 | Health | GET /api/health | status ok, version 0.1.6 |
